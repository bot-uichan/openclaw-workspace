...
screen.key(["i"], () => void client.importCookiesViaHelper(process.env.DLPLAY_AUTH_HELPER ?? "dlplay-auth-helper").then(() => info("cookie imported via auth helper")).catch((e) => err(String(e))));
screen.key(["?"], () => showHelp());
